package edu.indiana.d2i.matchmaker.test;
...
public class MatchMakerTests extends TestCase {
    ...
    public void testMM() throws ClassNotFoundException, IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException {
        ...
        POJOGenerator reposGen = new POJOGenerator("edu.indiana.d2i.matchmaker.pojo.Repository");
        reposGen.fromPath("../profile/repositories.json");
        POJOGenerator personGen = new POJOGenerator("edu.indiana.d2i.matchmaker.pojo.Person");
        personGen.fromPath("../profile/person.json");
        POJOGenerator researchObjectGen = new POJOGenerator("edu.indiana.d2i.matchmaker.pojo.ResearchObject");
        ...
        MatchMakingList initList = (MatchMakingList) Class.forName("edu.indiana.d2i.matchmaker.custom.ruleset1.Ruleset1MatchMakingList").getConstructor(ArrayNode.class).newInstance((ArrayNode) reposGen.getJsonTree());
        String[] classNames = new String[1];
        classNames[0] = new String("edu.indiana.d2i.matchmaker.custom.ruleset1.Ruleset1Utility");
